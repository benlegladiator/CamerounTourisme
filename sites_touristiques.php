...
$query = "SELECT * FROM sites_touristiques WHERE region_id = ?";
                  ...
                  <div class="col-md-6 mb-4">
                      <div class="card" style="max-width: 100%;">
                          <div class="row g-0">
                              ...
                              <div class="col-md-8">
                                  <div class="card-body">
                                      <a href="reservation.php?site_id=<?php echo $row['id']; ?>" class="btn btn-primary"><?php echo $row['nom']; ?></a>
                                      <h5 class="card-title"><?php echo $row['nom']; ?></h5>
                                      <p class="card-text"><?php echo $row['description']; ?></p>
                                      <p>Prix : <?php echo $row['prix']; ?> FCFA</p>
                                  </div>
                              </div>
                          </div>
                      </div>
