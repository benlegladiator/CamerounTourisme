...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT id, mot_de_passe FROM clients WHERE email='$email'";
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item pe-2">
              <a class="btn btn-order rounded-0 " href="inscription.php" >S'inscrire</a>
            </li>
          </ul>
      ...
      <div class="container my-5 py-5">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            Connectez-Vous Pour Effectuer <br> Une Reservation
            </h1>
